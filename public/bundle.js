...
(function () {
    ...
    function create_each_block(ctx) {
    	...
    	let p0;
    	let t3;
    	let t4_value = /*item*/ ctx[0].current + "";
    	let t4;
    	let t5;
    	let t6_value = /*item*/ ctx[0].total + "";
    	let t6;
    	let t7;
    	let div1;
    	let button0;
    	...
    	let small;
    	let t12;
    	let t13_value = /*item*/ ctx[0].lastUpdated + "";
    	let t13;
    	let t14;
    	...
    	return {
    		...
    		l(nodes) {
    			...
    			t3 = claim_text(p0_nodes, "Episode: ");
    			...
    			t12 = claim_text(small_nodes, "Last updated on: ");
    		...
    		h() {
    			if (img.src !== (img_src_value = "https://via.placeholder.com/150")) attr(img, "src", img_src_value);
    			attr(img, "class", "card-img");
    			attr(img, "alt", "");
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		...
    		l(nodes) {
    			...
    			t2 = claim_text(h2_nodes, "Add a new series");
    			...
    			t4 = claim_text(label0_nodes, "Series");
    			...
    			form1 = claim_element(div6_nodes, "FORM", {});
    			...
    			t7 = claim_text(label1_nodes, "Search");
    		...
    		h() {
    			...
    			attr(div1, "class", "row");
    			attr(label0, "for", "series");
    			attr(input0, "type", "text");
    			attr(input0, "class", "form-control");
    			attr(input0, "id", "seriesInput");
    			attr(input0, "placeholder", "Enter series name");
    			attr(div2, "class", "form-group");
    			attr(div3, "class", "col-md-12");
    			attr(div4, "class", "row");
    			attr(label1, "for", "search");
    			attr(input1, "type", "text");
    			attr(input1, "class", "form-control");
    			attr(input1, "id", "searchInput");
    			attr(input1, "placeholder", "Enter search name");
    			attr(div5, "class", "form-group");
    			attr(div6, "class", "col-md-12");
    			attr(div7, "class", "row");
    			attr(div8, "class", "row");
    		},
    		m(target, anchor) {
